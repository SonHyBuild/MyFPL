...
public class CLBFragment extends Fragment {
    ...
    public static CLBFragment newInstance(String param1, String param2) {
        CLBFragment fragment = new CLBFragment();
...
//        recyclerView.setLayoutManager(linearLayoutManager);
        ...
        Call<ArrayList<Course>> response = service.GetDSCLB();
